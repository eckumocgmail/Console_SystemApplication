...
namespace Console_SystemConsole
{
    using static System.Console;
    using static System.IO.Directory;
    using static ProgramFilesExecuter; 

    /// <summary>
    /// Создаёт командные файлы
    /// </summary>
    public class SystemConsoleProgram
    {
            ...
            do
            {
                ...
                switch (command = Console.ReadLine())
                {
                    ...
                    case "clear":
                        ...
                        break;
                    case "programs":
                        ProgramFilesExecuter.GetProgramFiles().ToList().ForEach(Console.WriteLine);
                        break;
                    case "save":
                        {
        ...
        {
            return RusEngTranslite.TransliteToLatine(command);
        }
        ...
        private static string TransliteToEn(string command) => 
            RusEngTranslite.TransliteToLatine(command);
        ...
        {
            foreach(var path in ProgramFilesExecuter.GetProgramFiles())
            {
                WriteLine();
